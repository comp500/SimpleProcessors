...
public class PacketDownCode implements IMessage {
	
	// THIS IS A PLACEHOLDER, DON'T USE THIS PACKET!
	...
	public PacketDownCode() {
		// Calculate the position of the block we are looking at
		RayTraceResult mouseOver = Minecraft.getMinecraft().objectMouseOver;
		blockPos = mouseOver.getBlockPos();
	}

	public static class Handler implements IMessageHandler<PacketDownCode, IMessage> {
		@Override
		public IMessage onMessage(PacketDownCode message, MessageContext ctx) {
		...
		private void handle(PacketDownCode message, MessageContext ctx) {
